...
export const Colors = {
  light: {
    ...
    backgroundSelected: 'rgba(14, 165, 233, 0.14)',
    backgroundElevated: 'rgba(248, 250, 252, 0.96)',
    textSecondary: 'rgba(51, 65, 85, 0.85)',
    textMuted: 'rgba(100, 116, 139, 0.95)',
    accent: '#E11D48',
    accentSecondary: '#0284C7',
    accentMuted: 'rgba(225, 29, 72, 0.12)',
    glowCyan: 'rgba(2, 132, 199, 0.25)',
    glowRose: 'rgba(225, 29, 72, 0.2)',
    surfaceBorder: 'rgba(148, 163, 184, 0.45)',
